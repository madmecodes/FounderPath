  ...
  return (
    <main className="relative h-[100dvh] overflow-hidden bg-ink">
      ...
      <img
        ...
        className="pointer-events-none absolute bottom-0 left-1/2 z-0 h-[34%] -translate-x-1/2 animate-floaty object-contain object-bottom pixelated opacity-95 drop-shadow-[0_10px_24px_rgba(0,0,0,0.55)] md:left-[4%] md:h-[82%] md:translate-x-0 md:opacity-100"
      />

      {/* hero content — centered on mobile, center-right on desktop */}
      <div className="relative z-10 flex h-full items-start justify-center px-6 pt-20 md:items-center md:justify-end md:pr-[8%] md:pt-0">
        <motion.div

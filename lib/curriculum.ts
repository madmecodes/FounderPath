...
export const WORLDS: World[] = [
  ...
  // ----------------------------------------------------------------- 1
  {
    ...
    questions: [
      ...
      { id: "cf2", type: "mcq", prompt: "To avoid a nasty future tax bill on vesting founder stock, within what window must you file an 83(b) election?", options: ["30 days of the grant", "1 year", "Before your first funding round", "Before the company is profitable"], correct: 0, explanation: "The 83(b) must be filed within 30 days of the grant. It elects to be taxed now (stock ~worthless) rather than as it vests (potentially valuable). Missing the window is a costly error.", concept: "83(b) election" },
      ...
      { id: "cf4", type: "mcq", prompt: "What must a US corporation's legal name include?", options: ["The founder's name", "A corporate designator like 'Inc.' or 'Corp.'", "The word 'Startup'", "A trademark symbol"], correct: 1, explanation: "Legal corporate names need a designator such as Inc., Corp., or Incorporated. You should also clear name availability, trademarks, and a domain before committing.", concept: "company naming" },
  ...
  // ----------------------------------------------------------------- 3
  {
    ...
    questions: [
      { id: "fi1", type: "mcq", prompt: "What is a convertible note, fundamentally?", options: ["Type of equity", "Loan designed to convert into shares", "Grant that never repays", "Government subsidy"], correct: 1, explanation: "A convertible note is debt: it has a maturity date and interest, and converts into equity at a later priced round.", concept: "convertible note" },
  ...
  // ----------------------------------------------------------------- 4
  {
    ...
    questions: [
      ...
      { id: "so2", type: "mcq", prompt: "On a sale or liquidation, what does a 1x liquidation preference give those investors?", options: ["Get 1% of the proceeds", "Get their original investment back before common shareholders get anything", "Vote first", "Get 1 extra share"], correct: 1, explanation: "Liquidation preference puts those investors first in line to recover (1× here) their money before common holders are paid.", concept: "liquidation preference" },
      { id: "so3", type: "mcq", prompt: "What does a stock option give an employee?", options: ["Free shares immediately", "The right to BUY shares later at a fixed strike price", "A cash bonus", "A board seat"], correct: 1, explanation: "An option is the right (not obligation) to buy shares at the strike price set at grant. It's valuable only if the company's value rises above that strike.", concept: "stock options" },
  ...
  // ----------------------------------------------------------------- 7
  {
    ...
    questions: [
      ...
      { id: "dd2", type: "mcq", prompt: "What is a 'data room'?", options: ["A physical server room", "A collected folder (often Google Drive) of all documents investors need to verify", "The investor's office", "A type of term sheet"], correct: 1, explanation: "It's the organized collection of financial, legal, IP, and staff documents investors review during diligence.", concept: "data room" },
  ...
  // ----------------------------------------------------------------- 9
  {
    ...
    questions: [
      ...
      { id: "ac5", type: "mcq", prompt: "What is the MOST valuable thing a good accelerator usually provides?", options: ["The cash", "The network — investors, hires, advisors, soft landings", "Free office snacks", "A guaranteed next round"], correct: 1, explanation: "The money is a small bridge; the durable value is the network and the crash course. The name badge helps but never guarantees a future raise.", concept: "accelerator value" },
    ],
  },
  ...
  // ----------------------------------------------------------------- 10  (BRANCHING)
  {
    ...
    questions: [
      ...
      { id: "ge2", type: "mcq", prompt: "What is generally considered a healthy LTV:CAC ratio (at least)?", options: ["1:1", "3:1", "10:1", "1:3"], correct: 1, explanation: "≥3:1 is the rule of thumb: a customer should be worth at least 3× what you spend to acquire them, with payback under ~12 months.", concept: "ltv:cac" },
      { id: "ge3", type: "mcq", prompt: "What does 'activation' mean in the growth funnel?", options: ["A user paying", "A new user reaching their first real 'aha' value moment", "Turning on a feature flag", "Signing up"], correct: 1, explanation: "Activation is the moment a new user first experiences the product's core value — distinct from merely acquiring (signing up) them.", concept: "activation" },
    ],
    branching: [
      {
        id: "plg",
        ...
        questions: [
          { id: "plg1", type: "mcq", prompt: "In Product-Led Growth, what is the primary driver of acquisition and expansion?", options: ["An outbound sales team", "The product itself (self-serve, viral)", "TV advertising", "Channel partners"], correct: 1, explanation: "PLG uses the product as the growth engine — self-serve signup, fast value, and built-in virality, with minimal sales.", concept: "plg" },
          ...
          { id: "plg3", type: "mcq", prompt: "What qualifies a 'PQL' (product-qualified lead)?", options: ["A salesperson's gut", "Their actual product usage/behavior hitting value", "Marketing email opens", "A partner referral"], correct: 1, explanation: "A PQL is qualified by in-product behavior signaling readiness to buy — the PLG analog of an MQL/SQL.", concept: "pql" },
          { id: "plg4", type: "mcq", prompt: "What does the viral coefficient (K-factor) measure?", options: ["Server uptime", "How many new users each existing user brings in", "Churn rate", "Gross margin"], correct: 1, explanation: "K-factor = invites sent × conversion rate. K>1 means self-sustaining viral growth — a PLG dream metric.", concept: "k-factor" },
        ],
      },
      {
        id: "slg",
        ...
        questions: [
          { id: "slg1", type: "mcq", prompt: "What is Sales-Led Growth the best fit for?", options: ["Cheap, self-serve consumer apps", "Expensive, complex, enterprise products with large contracts (high ACV)", "Viral social products", "Open-source tools"], correct: 1, explanation: "SLG suits high-ACV, complex/enterprise sales where buyers need demos, negotiation, and procurement — humans close the deal.", concept: "slg" },
          { id: "slg2", type: "mcq", prompt: "What is an 'SQL' in a sales funnel?", options: ["Database query", "Sales-Qualified Lead — vetted as a real opportunity by sales", "Standard Quarterly License", "Self-Qualified Login"], correct: 1, explanation: "MQL (marketing-qualified) → SQL (sales-qualified, a real opportunity) → deal. SQL means sales has vetted it as worth pursuing.", concept: "sql" },
          { id: "slg3", type: "mcq", prompt: "Compared to PLG, what does SLG typically have?", options: ["Lower CAC and shorter cycles", "Higher CAC and longer sales cycles, offset by larger contracts", "No CAC at all", "No need for metrics"], correct: 1, explanation: "Sales teams are expensive (higher CAC) and enterprise cycles are long, but large contract values justify the cost.", concept: "slg economics" },
          { id: "slg4", type: "mcq", prompt: "What does 'pipeline coverage' refer to?", options: ["Insurance for the sales team", "The ratio of open pipeline value to the sales target", "Server bandwidth", "Number of demos given"], correct: 1, explanation: "Pipeline coverage compares total open opportunity value against quota/target — a core SLG health metric (often 3–4× target).", concept: "pipeline" },
        ],
      },
      {
        id: "mlg",
        ...
        questions: [
          { id: "mlg1", type: "mcq", prompt: "What does Marketing-Led Growth primarily use to drive growth?", options: ["Outbound cold calling", "Content/SEO, paid ads, and brand generating inbound demand at scale", "Product virality only", "Channel partners only"], correct: 1, explanation: "MLG builds demand via content, SEO, ads, and brand, feeding an inbound funnel. It fits broad audiences with clear search intent.", concept: "mlg" },
          { id: "mlg2", type: "mcq", prompt: "What qualifies an 'MQL' (marketing-qualified lead)?", options: ["Product usage", "Marketing engagement signals (downloads, opens, content)", "A signed contract", "A partner"], correct: 1, explanation: "A Marketing-Qualified Lead shows enough marketing engagement to be worth passing toward sales or self-serve conversion.", concept: "mql" },
          { id: "mlg3", type: "mcq", prompt: "What is the classic risk of a paid-ads-heavy MLG motion?", options: ["Too much organic traffic", "CAC rising faster than LTV, stalling growth", "Too many product-qualified leads", "Negative churn"], correct: 1, explanation: "Heavy reliance on paid channels means growth dies if acquisition cost climbs above what a customer is worth.", concept: "paid risk" },
  ...
  // ----------------------------------------------------------------- 11
  {
    ...
    questions: [
      { id: "tg1", type: "mcq", prompt: "Where should the skills to get a startup from $0 to ~$100k in revenue mainly come from?", options: ["Your first hires", "Your co-founding team", "Outside consultants", "An agency"], correct: 1, explanation: "Early on you can't pay for top talent, so the critical 0→$100k skills must be covered by co-founders. You bring game-changers as co-founders, not hires.", concept: "co-founder skill coverage" },
      { id: "tg2", type: "mcq", prompt: "When choosing co-founders, what do you ideally want?", options: ["As many as possible for more skills", "People who each cover more than one critical skill, keeping the team small", "Only people identical to you", "Pure investors"], correct: 1, explanation: "Fewer co-founders is better — each should cover multiple critical skills so you keep the team (and the mouths to feed on no salary) as small as possible.", concept: "fewer co-founders" },
      ...
      { id: "tg4", type: "mcq", prompt: "Why did SlideBean add a Myers-Briggs personality test to its hiring?", options: ["Measure intelligence", "Check personality compatibility with teammates and the direct manager", "Replace interviews", "Set salaries"], correct: 1, explanation: "It was used to gauge whether a candidate's personality would fit with the rest of the team — especially their teammates and direct superior.", concept: "team fit" },
      ...
      { id: "tg6", type: "mcq", prompt: "When you double a team from ~10 to ~20 people, what usually happens to productivity?", options: ["Doubles", "More than doubles", "Grows less than proportionally, due to coordination & management overhead", "Stays exactly flat"], correct: 2, explanation: "You'd expect double, but you now pay for management, delegation, coordination and communication — so output grows less than proportionally.", concept: "coordination overhead" },
      { id: "tg7", type: "mcq", prompt: "In SlideBean's structure, what is a 'Lead'?", options: ["A manager with direct reports", "A senior individual contributor with a title/pay bump who spearheads a team but doesn't manage people", "An external advisor", "A C-level officer"], correct: 1, explanation: "Leads are senior ICs recognized with a title and pay bump. Many don't want to manage people — their job is to be great at their craft and lead by example.", concept: "lead vs manager" },
      { id: "tg8", type: "mcq", prompt: "What best defines a 'Director' in this structure?", options: ["Writing the most code", "Owning a whole branch with managers reporting to them and making metrics-driven decisions", "Having the highest salary", "Being the founder's friend"], correct: 1, explanation: "Directors own large branches (with one or more managers reporting to them), deeply understand the work, make metrics-driven calls, and influence company direction.", concept: "director" },
    ],
  },
  ...
  // ----------------------------------------------------------------- 13
  {
    ...
    questions: [
      ...
      { id: "ex5", type: "mcq", prompt: "In M&A, how do 'signing' and 'closing' differ?", options: ["Always the same moment", "Sometimes separate — closing (funding the deal) can require conditions met after signing", "Both before due diligence", "Done by the buyer alone"], correct: 1, explanation: "Signing the merger docs and closing (actually funding the transaction) can be distinct; conditional deals require milestones between sign and close.", concept: "sign vs close" },
      { id: "ex6", type: "mcq", prompt: "Throughout the company's life, where does control ultimately come from?", options: ["Owning the most equity", "The board of directors and voting rights", "Being the CEO", "The largest investor"], correct: 1, explanation: "Control rests with the board and voting rights, not raw ownership percentage. The founder's endgame is selling shares well — not clinging to a majority.", concept: "control vs ownership" },
    ],
  },
];
